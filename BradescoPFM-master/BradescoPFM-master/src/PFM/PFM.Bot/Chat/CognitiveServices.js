...
var CognitiveServicesHelper = (function () {
    function CognitiveServicesHelper(apiKey) {
    ...
    CognitiveServicesHelper.prototype.fetchSpeechData = function (text, locale, synthesisProperties) {
        var _this = this;
        return this.checkAuthToken().then(function () {
            var optionalHeaders = [{ name: "Content-type", value: 'application/ssml+xml' },
                { name: "X-Microsoft-OutputFormat", value: _this._outputFormat },
                { name: "Authorization", value: _this._token },
                { name: "Ocp-Apim-Subscription-Key", value: _this._apiKey }];
            var SSML = _this.makeSSML(text, locale, synthesisProperties);
    ...
    CognitiveServicesHelper.prototype.checkAuthToken = function () {
        var _this = this;
